...
class SentimentAnalyzer:
    ...
    def generate_insights(self):
        ...
        if positive_pct > 60:
            ...
            insights.append("   ⚠️  CONCERNING - High negative sentiment detected")
...
def main():
    ...
    print("\n2️⃣  Loading from CSV (if available)...")
    ...
    for filename in ['reviews.csv', 'data.csv', 'amazon_reviews.csv']:
        ...
        print("   ℹ️  No CSV file found. Using sample data only.")
    ...
    # Generate insights
    print("\n5️⃣  Generating Business Insights...")
